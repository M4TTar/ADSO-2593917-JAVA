...
public class Facturador extends JFrame{
	...
	private Persona2 listaVendedores [];
	// private Cedulas listaClientes [];
	// private Nombres listaClientes [];
	// private Direccion listaClientes [];
	...
	// Metodos
	public Facturador(Persona[] listaClientes, Persona2[] listaVendedores){
	...
	public void initComponent(){
		...
		*/
		...
		btn_buscar_vendedor.addActionListener( evento_02 );
	}
	...
	public void buscarVendedor(){
		String texto2 = input_cedula_vendedor.getText();
		boolean encontrado2 = false;
		for (int i = 0; i < this.listaVendedores.length; i++) {
			if (this.listaVendedores[i]!=null && this.listaVendedores[i].getCedulaVendedor().equalsIgnoreCase(texto2)){
				this.input_nombres_vendedor.setText( this.listaVendedores[i].getNombresVendedor());
				encontrado2 = true;
				break;
			}
		}
		...
		if(encontrado2){
			...
			habilitarInput(this.input_nombres_vendedor);
			this.input_nombres_vendedor.requestFocus();
		}
	}
