...
import com.example.pokeapirecycler.AdaptadorPokemon;
import com.example.pokeapirecycler.Pokemon;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycler = findViewById(R.id.recyclar_pokemons);
    ...
    public void nextListstPokemons(View view) {
        RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
    ...
    public void previousListPokemons(View view) {
        RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
