...
public class DetallesPokemon extends AppCompatActivity {
    ...
    AdaptadorHabilidades adaptador_habilidades_pokemon;
    List<HabilidadesPokemon> lista_habilidades_pokemon;

    List<String> lista_imagenes_pokemon;
    AdaptadorImagen adaptador_imagenes_pokemon;
        ...
        JsonObjectRequest solicitud = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    adaptador_imagenes_pokemon = new AdaptadorImagen(lista_imagenes_pokemon);
                    ...
                    adaptador_habilidades_pokemon = new AdaptadorHabilidades(lista_habilidades_pokemon);
